...
TEMPLATES: list[DeviceTemplate] = [
    ...
    DeviceTemplate(
        id="alstom/atcs/office",
        vendor="Alstom",
        vendor_family="ATCS",
        model="ATCS Office Dispatch System",
        model_name="Alstom ATCS Office Dispatch System",
        device_type="atcs_office",
        description="Dispatch/CTC office system; subscribes to the ATCS codeline feed from base stations to display track and signal status",
        oui_prefixes=["00:16:9B"],
        tcp_stack=_TCP,
        response_timing=_ATCS_TIMING,
