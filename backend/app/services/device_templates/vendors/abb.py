    ...
    DeviceTemplate(
        ...
        firmware_variants=[
            ...
            FirmwareVariant(
                ...
                cves=["CVE-2022-4046", "CVE-2023-37559"],
            ),
        ],
    ...
    DeviceTemplate(
        ...
        firmware_variants=[
            ...
            FirmwareVariant(
                ...
                cves=["CVE-2022-1596", "CVE-2024-8036"],
            ),
        ],
    ...
    DeviceTemplate(
        ...
        firmware_variants=[
            FirmwareVariant(
                ...
                is_latest=True,
                is_default=True,
                cves=["CVE-2023-5768", "CVE-2023-5769"],
            ),
            FirmwareVariant(
                version="V12.2.0",
    ...
    DeviceTemplate(
        ...
        firmware_variants=[
            FirmwareVariant(
                ...
                is_latest=True,
                is_default=True,
                cves=["CVE-2019-18253", "CVE-2021-35534"],
            ),
            FirmwareVariant(
                version="V2.2.3",
                release_date=date(2022, 11, 8),
                cves=["CVE-2019-18253", "CVE-2021-27196", "CVE-2021-35534"],
            ),
            FirmwareVariant(
                version="V2.2.0",
