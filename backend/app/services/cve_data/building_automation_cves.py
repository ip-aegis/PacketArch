...
BUILDING_AUTOMATION_CVES: list[dict] = [
    ...
    {
        "cve_id": "CVE-2021-35963",
        "title": "Automated Logic WebCTRL SQL Injection",
        "description": (
            "Automated Logic WebCTRL server contains SQL injection "
            "vulnerabilities that allow remote attackers to execute "
            "arbitrary SQL commands and access the building control database."
        ),
        "severity": "critical",
        "cvss_score": 9.8,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
        ...
        "affected_models": ["WebCTRL Server", "i-Vu Server"],
        "affected_firmware_min": None,
        "affected_firmware_max": "8.4.0",
        "fixed_firmware_version": "8.5.0",
        "cyber_vision_detectable": True,
        "detection_method": "bacnet_i_am",
        "advisory_url": "https://www.cisa.gov/news-events/ics-advisories/icsa-21-231-01",
        "references": [],
        "mitre_techniques": ["T0859", "T0882"],
        "exploit_available": True,
        "exploit_complexity": "low",
        "published_date": datetime(2021, 8, 19),
        "vulnerable_variants": [
            {
                "firmware_version": "8.4.0",
                "display_name": "Automated Logic WebCTRL Server (CVE-2021-35963)",
                "snmp_sys_descr_template": "Automated Logic WebCTRL Server v{firmware_version}",
                "bacnet_identity_override": {
                    "vendor_id": 86,
    ...
    {
        "cve_id": "CVE-2020-7002",
        "title": "Carrier i-Vu Web Server Path Traversal",
        "description": (
            "Carrier i-Vu web-based building automation server contains "
            "path traversal vulnerabilities allowing attackers to access "
        ...
        "vendor": "Carrier",
        "product_family": "i-Vu",
        "affected_models": ["i-Vu Pro", "i-Vu Open"],
        "affected_firmware_min": None,
        "affected_firmware_max": "6.9.0",
        "fixed_firmware_version": "7.0.0",
        "cyber_vision_detectable": True,
        "detection_method": "bacnet_i_am",
        ...
        "vulnerable_variants": [
            {
                "firmware_version": "6.9.0",
                "display_name": "Carrier i-Vu Pro (CVE-2020-7002)",
                "snmp_sys_descr_template": "Carrier i-Vu Pro Server v{firmware_version}",
                "bacnet_identity_override": {
                    "vendor_id": 301,
                    "vendor_name": "Carrier",
    ...
    {
        "cve_id": "CVE-2020-9049",
        "title": "Distech Controls ECLYPSE Authentication Bypass",
        "description": (
            "Distech Controls ECLYPSE controllers contain an authentication "
            "bypass vulnerability that allows attackers to access the device "
            "configuration without proper credentials."
        ),
        "severity": "high",
        "cvss_score": 7.5,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N",
        ...
        "affected_models": ["ECLYPSE Connected", "EC-BOS-8"],
        "affected_firmware_min": None,
        "affected_firmware_max": "4.0.1",
        "fixed_firmware_version": "4.1.0",
        "cyber_vision_detectable": True,
        "detection_method": "bacnet_i_am",
        "advisory_url": "https://www.cisa.gov/news-events/ics-advisories/icsa-20-161-01",
        "references": [],
        "mitre_techniques": ["T0859", "T0831"],
        "exploit_available": False,
        "exploit_complexity": "low",
        "published_date": datetime(2020, 6, 9),
        "vulnerable_variants": [
            {
                "firmware_version": "4.0.1",
                "display_name": "Distech EC-BOS-8 (CVE-2020-9049)",
                "snmp_sys_descr_template": "Distech Controls EC-BOS-8 v{firmware_version}",
                "bacnet_identity_override": {
                    "vendor_id": 165,
    ...
    {
        "cve_id": "CVE-2022-31465",
        "title": "Siemens Desigo CC Privilege Escalation",
        "description": (
            "Siemens Desigo CC building automation software contains a "
            "privilege escalation vulnerability allowing authenticated "
        ...
        "affected_models": ["Desigo CC", "Desigo CC Compact"],
        "affected_firmware_min": None,
        "affected_firmware_max": "5.29.0",
        "fixed_firmware_version": "5.30.0",
        "cyber_vision_detectable": True,
        "detection_method": "bacnet_i_am",
        "advisory_url": "https://cert-portal.siemens.com/productcert/pdf/ssa-836027.pdf",
        "references": [],
        ...
        "vulnerable_variants": [
            {
                "firmware_version": "5.29.0",
                "display_name": "Siemens DXR2 Controller (CVE-2022-31465)",
                "snmp_sys_descr_template": "Siemens Desigo DXR2 Controller v{firmware_version}",
                "bacnet_identity_override": {
                    "vendor_id": 24,
                    "vendor_name": "Siemens",
