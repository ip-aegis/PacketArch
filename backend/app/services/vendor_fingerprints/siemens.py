...
def get_siemens_fingerprints() -> list[dict[str, Any]]:
    ...
    return [
        ...
        # ============================================================
        # SIMATIC WinCC SCADA/HMI Software
        # ============================================================
        # WinCC Professional (TIA Portal integrated)
        {
            "vendor": "Siemens",
            "vendor_family": "SIMATIC WinCC",
            "model": "WinCC Professional",
            "firmware_version": "V18.0",
            "oui_prefixes": SIEMENS_OUI_PREFIXES,
            "supported_protocols": ["s7comm", "opc_ua", "modbus"],
            "s7_identity": {
        ...
        # WinCC Unified (New generation HMI)
        {
            "vendor": "Siemens",
            "vendor_family": "SIMATIC WinCC",
            "model": "WinCC Unified",
            ...
            "tcp_stack": {
                "ttl": 64,  # Linux-based unified panels
                "window_size": 32768,
                "mss": 1460,
                "sack_permitted": True,
                "timestamps_enabled": True,
        ...
        # TIA Portal Engineering Station
        {
            "vendor": "Siemens",
            ...
            "profinet_identity": {
                ...
                "device_role": 0,  # Engineering/Supervisor
                "im0_manufacturer": "Siemens AG",
