...
from app.api.routes import about, acknowledgments, adaptation, admin, agent_install, agents, ai, ai_usage, anomalies, architecture as architecture_routes, attacks, auth, cloud_services, cml, cve, cyber_vision, dashboard, deployments, downloads, feedback, fingerprints, generation, health, health_monitor as health_monitor_routes, ip_management, ldap, local_sensor, mimic, protocols, scenario_versions, scenarios, setup as setup_routes, site_config, stats, system as system_routes, templates, topology_sensor, users
from app.api.websocket import agent_hub
from app.api.deps import RequireLiveTrafficEnabled, RequireMimicEnabled, RequireMultiSensorTopology, RequireSetupComplete, get_current_user
...
app.include_router(mimic.router, prefix=settings.api_prefix, dependencies=[RequireSetupComplete, RequireMimicEnabled])
