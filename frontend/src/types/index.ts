...
// Conduit direction
export type ConduitDirection = 'bidirectional' | 'a_to_b' | 'b_to_a';

// Conduit compliance status
export type ComplianceStatus = 'compliant' | 'non_compliant' | 'partial' | 'unchecked';

// Conduit between zones (IEC 62443)
export interface ScenarioConduit {
  id: string;
  name: string;
  sourceZoneId: string;
  targetZoneId: string;
  ...
  securityLevel?: 'minimal' | 'standard' | 'high' | 'critical';
  description?: string;
